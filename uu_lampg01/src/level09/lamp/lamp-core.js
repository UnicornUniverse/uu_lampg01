...
export const LampCore = createVisualComponent({
  ...
  render(props) {
    ...
    return (
      <LampProvider baseUri={props.baseUri} on={props.on}>
        {(lampDataObject) => {
          function handleSwitchClick() {
            lampDataObject.data.setOn(!lampDataObject.data.on);
          }
          ...
          return (
            <LampView
              ...
              showSwitch={lampDataObject.canSwitch}
              onSwitchClick={lampDataObject.canSwitch ? handleSwitchClick : undefined}
              {...attrs}
            />
          );
        }}
